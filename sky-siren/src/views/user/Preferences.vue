    ...
    <main class="container flex-shrink-0  mt-4">
        ...
        <form class="mx-auto col-lg-4 col-md-6 col-sm-8 col-xs-12" style="color: white" @submit.prevent="updatePreference">
            ...
            <div class="mb-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="temperatureUnitKelvin" value="kelvin"
                        v-model="temperatureUnit">
            ...
            <div class="mb-4">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="weatherAlerts"
                        v-model="weatherAlerts">
